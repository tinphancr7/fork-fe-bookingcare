				...
				<div className="flex flex-col flex-1 pt-5 pb-4 overflow-y-auto">
					<div className="flex-1 px-3 space-y-1 bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
						<ul className="pb-2 space-y-2">
							...
							<li>
								<a className="flex items-center p-2 text-base text-gray-900 rounded-lg hover:bg-gray-100 group dark:text-gray-200 dark:hover:bg-gray-700">
									<svg
							...
							<li>
								...
								<ul id="dropdown-layouts" className="hidden py-2 space-y-2">
									<li>
										<a className="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700">
											Stacked
										</a>
									</li>
									<li>
							...
							<li>
								...
								<ul id="dropdown-crud" className="space-y-2 py-2 hidden">
									<li>
										<button
											type="button"
											className="flex items-center w-full p-2 pl-10 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700"
											aria-controls="dropdown-crud-doctor"
											data-collapse-toggle="dropdown-crud-doctor"
										>
											<GiDoctorFace size={20} className="text-gray-500" />
											<span
												className="flex-1 ml-3 text-left whitespace-nowrap"
												sidebar-toggle-item
											>
										...
										<ul
											id="dropdown-crud-doctor"
											className="space-y-2 py-2 hidden"
										>
											<li>
												<a className="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700 ">
													List Doctor
												</a>
											</li>
											<li>
